...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Finding.created_by'
        db.add_column(u'drugtrials_finding', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='finding_created-by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Finding.created_on'
        db.add_column(u'drugtrials_finding', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Finding.modified_by'
        db.add_column(u'drugtrials_finding', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='finding_modified-by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Finding.modified_on'
        db.add_column(u'drugtrials_finding', 'modified_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Finding.signed_off_by'
        db.add_column(u'drugtrials_finding', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='finding_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Finding.signed_off_date'
        db.add_column(u'drugtrials_finding', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Finding.locked'
        db.add_column(u'drugtrials_finding', 'locked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Finding.created_by'
        db.delete_column(u'drugtrials_finding', 'created_by_id')

        # Deleting field 'Finding.created_on'
        db.delete_column(u'drugtrials_finding', 'created_on')

        # Deleting field 'Finding.modified_by'
        db.delete_column(u'drugtrials_finding', 'modified_by_id')

        # Deleting field 'Finding.modified_on'
        db.delete_column(u'drugtrials_finding', 'modified_on')

        # Deleting field 'Finding.signed_off_by'
        db.delete_column(u'drugtrials_finding', 'signed_off_by_id')

        # Deleting field 'Finding.signed_off_date'
        db.delete_column(u'drugtrials_finding', 'signed_off_date')

        # Deleting field 'Finding.locked'
        db.delete_column(u'drugtrials_finding', 'locked')
