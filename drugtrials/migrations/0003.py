...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Test.signed_off_by'
        db.add_column(u'drugtrials_test', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='test_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Test.signed_off_date'
        db.add_column(u'drugtrials_test', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DrugTrial.signed_off_by'
        db.add_column(u'drugtrials_drugtrial', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='drugtrial_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'DrugTrial.signed_off_date'
        db.add_column(u'drugtrials_drugtrial', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Test.signed_off_by'
        db.delete_column(u'drugtrials_test', 'signed_off_by_id')

        # Deleting field 'Test.signed_off_date'
        db.delete_column(u'drugtrials_test', 'signed_off_date')

        # Deleting field 'DrugTrial.signed_off_by'
        db.delete_column(u'drugtrials_drugtrial', 'signed_off_by_id')

        # Deleting field 'DrugTrial.signed_off_date'
        db.delete_column(u'drugtrials_drugtrial', 'signed_off_date')
