...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DrugTrial.description'
        db.alter_column(u'drugtrials_drugtrial', 'description', self.gf('django.db.models.fields.CharField')(max_length=1400, null=True))

        # Changing field 'DrugTrial.condition'
        db.alter_column(u'drugtrials_drugtrial', 'condition', self.gf('django.db.models.fields.CharField')(max_length=1400, null=True))

    def backwards(self, orm):

        # Changing field 'DrugTrial.description'
        db.alter_column(u'drugtrials_drugtrial', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'DrugTrial.condition'
        db.alter_column(u'drugtrials_drugtrial', 'condition', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))
    ...
    models = {
        ...
        u'drugtrials.drugtrial': {
            ...
            'condition': ('django.db.models.fields.CharField', [], {'max_length': '1400', 'null': 'True', 'blank': 'True'}),
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1400', 'null': 'True', 'blank': 'True'}),
            'figure1': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'figure2': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
