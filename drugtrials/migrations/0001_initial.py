...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='test_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('organ', models.ForeignKey(blank=True, to='cellsamples.Organ', null=True)),
...
, on_delete=models.CASCADE                ('drug_trial', models.ForeignKey(to='drugtrials.DrugTrial')),
, on_delete=models.CASCADE                ('test_name', models.ForeignKey(verbose_name=b'Test', blank=True, to='drugtrials.Test', null=True)),
, on_delete=models.CASCADE                ('time_units', models.ForeignKey(blank=True, to='assays.TimeUnits', null=True)),
, on_delete=models.CASCADE                ('value_units', models.ForeignKey(blank=True, to='assays.PhysicalUnits', null=True)),
, on_delete=models.CASCADE            ],
            options={
            },
            bases=(models.Model,),
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='testtype_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='testtype_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
                'ordering': ('test_type',),
            },
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='trialsource_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='trialsource_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
