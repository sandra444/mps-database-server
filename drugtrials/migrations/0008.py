...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DrugTrial.description'
        db.alter_column(u'drugtrials_drugtrial', 'description', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'DrugTrial.condition'
        db.alter_column(u'drugtrials_drugtrial', 'condition', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        u'drugtrials.drugtrial': {
            ...
            'condition': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
