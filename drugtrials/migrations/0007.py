...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DrugTrial.figure1'
        db.add_column(u'drugtrials_drugtrial', 'figure1',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DrugTrial.figure2'
        db.add_column(u'drugtrials_drugtrial', 'figure2',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DrugTrial.figure1'
        db.delete_column(u'drugtrials_drugtrial', 'figure1')

        # Deleting field 'DrugTrial.figure2'
        db.delete_column(u'drugtrials_drugtrial', 'figure2')
