...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FindingResult.frequency'
        db.add_column(u'drugtrials_findingresult', 'frequency',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FindingResult.frequency'
        db.delete_column(u'drugtrials_findingresult', 'frequency')
    ...
    models = {
        ...
        u'drugtrials.findingresult': {
            ...
            'frequency': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
