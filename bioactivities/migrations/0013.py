...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bioactivity.chembl_assay_type'
        db.add_column(u'bioactivities_bioactivity', 'chembl_assay_type',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bioactivity.chembl_assay_type'
        db.delete_column(u'bioactivities_bioactivity', 'chembl_assay_type')
    ...
    models = {
        ...
        u'bioactivities.bioactivity': {
            ...
            'chembl_assay_type': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
