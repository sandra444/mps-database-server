...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assay.signed_off_by'
        db.add_column(u'bioactivities_assay', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assay_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Assay.signed_off_date'
        db.add_column(u'bioactivities_assay', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Target.signed_off_by'
        db.add_column(u'bioactivities_target', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='target_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Target.signed_off_date'
        db.add_column(u'bioactivities_target', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bioactivity.signed_off_by'
        db.add_column(u'bioactivities_bioactivity', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bioactivity_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Bioactivity.signed_off_date'
        db.add_column(u'bioactivities_bioactivity', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assay.signed_off_by'
        db.delete_column(u'bioactivities_assay', 'signed_off_by_id')

        # Deleting field 'Assay.signed_off_date'
        db.delete_column(u'bioactivities_assay', 'signed_off_date')

        # Deleting field 'Target.signed_off_by'
        db.delete_column(u'bioactivities_target', 'signed_off_by_id')

        # Deleting field 'Target.signed_off_date'
        db.delete_column(u'bioactivities_target', 'signed_off_date')

        # Deleting field 'Bioactivity.signed_off_by'
        db.delete_column(u'bioactivities_bioactivity', 'signed_off_by_id')

        # Deleting field 'Bioactivity.signed_off_date'
        db.delete_column(u'bioactivities_bioactivity', 'signed_off_date')
