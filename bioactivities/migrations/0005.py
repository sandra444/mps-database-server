...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BioactivityTypeTable.chembl_name'
        db.delete_column(u'bioactivities_bioactivitytypetable', 'chembl_name')

        # Adding field 'BioactivityTypeTable.chembl_bioactivity'
        db.add_column(u'bioactivities_bioactivitytypetable', 'chembl_bioactivity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bioactivities.Bioactivity'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BioactivityTypeTable.chembl_name'
        db.add_column(u'bioactivities_bioactivitytypetable', 'chembl_name',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Deleting field 'BioactivityTypeTable.chembl_bioactivity'
        db.delete_column(u'bioactivities_bioactivitytypetable', 'chembl_bioactivity_id')
    ...
    models = {
        ...
        u'bioactivities.bioactivitytypetable': {
            ...
            'chembl_bioactivity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bioactivities.Bioactivity']", 'null': 'True', 'blank': 'True'}),
