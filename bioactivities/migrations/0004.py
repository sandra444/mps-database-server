...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bioactivities_bioactivitytypetable', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bioactivitytypetable_created-by', null=True, to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bioactivitytypetable_modified-by', null=True, to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('signed_off_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bioactivitytypetable_signed_off_by', null=True, to=orm['auth.User'])),
            ('signed_off_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('locked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('chembl_name', self.gf('django.db.models.fields.TextField')(default='')),
    ...
    models = {
        ...
        u'bioactivities.bioactivitytypetable': {
            ...
            'chembl_name': ('django.db.models.fields.TextField', [], {'default': "''"}),
