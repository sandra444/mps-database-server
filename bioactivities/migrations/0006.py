...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'BioactivityTypeTable.chembl_bioactivity' to match new field type.
        db.rename_column(u'bioactivities_bioactivitytypetable', 'chembl_bioactivity_id', 'chembl_bioactivity')
        # Changing field 'BioactivityTypeTable.chembl_bioactivity'
        db.alter_column(u'bioactivities_bioactivitytypetable', 'chembl_bioactivity', self.gf('django.db.models.fields.TextField')())
        # Removing index on 'BioactivityTypeTable', fields ['chembl_bioactivity']
        db.delete_index(u'bioactivities_bioactivitytypetable', ['chembl_bioactivity_id'])


    def backwards(self, orm):
        # Adding index on 'BioactivityTypeTable', fields ['chembl_bioactivity']
        db.create_index(u'bioactivities_bioactivitytypetable', ['chembl_bioactivity_id'])
        ...
        # Renaming column for 'BioactivityTypeTable.chembl_bioactivity' to match new field type.
        db.rename_column(u'bioactivities_bioactivitytypetable', 'chembl_bioactivity', 'chembl_bioactivity_id')
        # Changing field 'BioactivityTypeTable.chembl_bioactivity'
        db.alter_column(u'bioactivities_bioactivitytypetable', 'chembl_bioactivity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bioactivities.Bioactivity'], null=True))
    ...
    models = {
        ...
        u'bioactivities.bioactivity': {
            ...
            'chembl_bioactivity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bioactivities.BioactivityTypeTable']", 'null': 'True', 'blank': 'True'}),
        ...
        u'bioactivities.bioactivitytypetable': {
            'Meta': {'object_name': 'BioactivityTypeTable'},
            'chembl_bioactivity': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'bioactivitytypetable_created-by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'default': "''"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locked': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'bioactivitytypetable_modified-by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'signed_off_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'bioactivitytypetable_signed_off_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'signed_off_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
