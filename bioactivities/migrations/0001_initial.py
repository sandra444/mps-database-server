...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assay_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='assay_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
...
, on_delete=models.CASCADE                ('compound', models.ForeignKey(related_name='bioactivity_compound', to='compounds.Compound')),
, on_delete=models.CASCADE                ('created_by', models.ForeignKey(related_name='bioactivity_created_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='bioactivity_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('parent_compound', models.ForeignKey(related_name='bioactivity_parent', to='compounds.Compound')),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='bioactivity_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='bioactivitytype_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='bioactivitytype_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
...
, on_delete=models.CASCADE                ('created_by', models.ForeignKey(related_name='pubchembioactivity_created_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='pubchembioactivity_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='pubchembioactivity_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
                'abstract': False,
            },
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='pubchemtarget_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='pubchemtarget_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
                'abstract': False,
            },
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='target_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='target_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
                'ordering': ('name',),
            },
