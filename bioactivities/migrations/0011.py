...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'BioactivityType', fields ['chembl_bioactivity']
        db.delete_unique(u'bioactivities_bioactivitytype', ['chembl_bioactivity'])

        # Removing unique constraint on 'Bioactivity', fields ['standard_name']
        db.delete_unique(u'bioactivities_bioactivity', ['standard_name'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'Bioactivity', fields ['standard_name']
        db.create_unique(u'bioactivities_bioactivity', ['standard_name'])

        # Adding unique constraint on 'BioactivityType', fields ['chembl_bioactivity']
        db.create_unique(u'bioactivities_bioactivitytype', ['chembl_bioactivity'])
    ...
    models = {
        ...
        u'bioactivities.bioactivitytype': {
            ...
            'signed_off_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'standard_name': ('django.db.models.fields.TextField', [], {'default': "''", 'unique': 'True'}),
