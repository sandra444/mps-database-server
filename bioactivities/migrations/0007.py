...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'BioactivityTypeTable'
        db.delete_table(u'bioactivities_bioactivitytypetable')

        # Adding model 'BioactivityType'
        db.create_table(u'bioactivities_bioactivitytype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bioactivitytype_created-by', null=True, to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bioactivitytype_modified-by', null=True, to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('signed_off_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bioactivitytype_signed_off_by', null=True, to=orm['auth.User'])),
            ('signed_off_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('locked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('chembl_bioactivity', self.gf('django.db.models.fields.TextField')(default='')),
            ('standard_name', self.gf('django.db.models.fields.TextField')(default='')),
            ('description', self.gf('django.db.models.fields.TextField')(default='')),
            ('standard_unit', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal(u'bioactivities', ['BioactivityType'])

        # Deleting field 'Bioactivity.chembl_bioactivity'
        db.delete_column(u'bioactivities_bioactivity', 'chembl_bioactivity_id')

        # Adding field 'Bioactivity.standardized_name'
        db.add_column(u'bioactivities_bioactivity', 'standardized_name',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'BioactivityTypeTable'
        db.create_table(u'bioactivities_bioactivitytypetable', (
            ('description', self.gf('django.db.models.fields.TextField')(default='')),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('standard_unit', self.gf('django.db.models.fields.TextField')(default='')),
            ('signed_off_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bioactivitytypetable_modified-by', null=True, to=orm['auth.User'], blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('locked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('standard_name', self.gf('django.db.models.fields.TextField')(default='')),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bioactivitytypetable_created-by', null=True, to=orm['auth.User'], blank=True)),
            ('signed_off_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bioactivitytypetable_signed_off_by', null=True, to=orm['auth.User'], blank=True)),
            ('chembl_bioactivity', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal(u'bioactivities', ['BioactivityTypeTable'])

        # Deleting model 'BioactivityType'
        db.delete_table(u'bioactivities_bioactivitytype')

        # Adding field 'Bioactivity.chembl_bioactivity'
        db.add_column(u'bioactivities_bioactivity', 'chembl_bioactivity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bioactivities.BioactivityTypeTable'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Bioactivity.standardized_name'
        db.delete_column(u'bioactivities_bioactivity', 'standardized_name')
    ...
    models = {
        ...
        u'bioactivities.bioactivity': {
            ...
            'signed_off_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'standardized_name': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'bioactivities.bioactivitytype': {
            'Meta': {'object_name': 'BioactivityType'},
