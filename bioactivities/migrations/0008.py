...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bioactivity.standard_name'
        db.add_column(u'bioactivities_bioactivity', 'standard_name',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Bioactivity.standard_name'
        db.delete_column(u'bioactivities_bioactivity', 'standard_name')
