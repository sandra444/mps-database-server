...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssayTestResult.chip_setup'
        db.add_column(u'assays_assaytestresult', 'chip_setup',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=6, to=orm['assays.AssayChipSetup']),
                      keep_default=False)


        # Changing field 'AssayResult.assay_name'
        db.alter_column(u'assays_assayresult', 'assay_name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.AssayChipReadoutAssay']))

    def backwards(self, orm):
        # Deleting field 'AssayTestResult.chip_setup'
        db.delete_column(u'assays_assaytestresult', 'chip_setup_id')


        # Changing field 'AssayResult.assay_name'
        db.alter_column(u'assays_assayresult', 'assay_name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.AssayChipReadout']))
