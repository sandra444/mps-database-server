...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AssayChipReadout'
        db.create_table(u'assays_assaychipreadout', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaychipreadout_created-by', null=True, to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaychipreadout_modified-by', null=True, to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('signed_off_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaychipreadout_signed_off_by', null=True, to=orm['auth.User'])),
            ...
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.PhysicalUnits'])),
            ...
            ('device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['microdevices.Microdevice'])),
            ...
            ('timeunit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.TimeUnits'])),
            ('treatment_time_length', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('assay_start_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('readout_start_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'assays', ['AssayChipReadout'])

        # Adding model 'AssayChipRawData'
        db.create_table(u'assays_assaychiprawdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('assay_chip_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.AssayChipReadout'])),
            ('field_id', self.gf('django.db.models.fields.CharField')(default='0', max_length=255)),
            ('value', self.gf('django.db.models.fields.FloatField')()),
            ('elapsed_time', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
        db.send_create_signal(u'assays', ['AssayChipRawData'])


    def backwards(self, orm):
        # Deleting model 'AssayChipReadout'
        db.delete_table(u'assays_assaychipreadout')

        # Deleting model 'AssayChipRawData'
        db.delete_table(u'assays_assaychiprawdata')
