# Generated by Django 2.1.9 on 2019-10-22 21:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('standard_value_unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='assays.PhysicalUnits', verbose_name='Reporting Unit')),
                ('study', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='assays.AssayStudy')),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name='assayplatereadermapitem',
            unique_together={('assayplatereadermap', 'plate_index'), ('assayplatereadermap', 'row_index', 'column_index')},
        ),
        migrations.AlterUniqueTogether(
            name='assayplatereadermap',
