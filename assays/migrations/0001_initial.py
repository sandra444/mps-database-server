...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='timeunits_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='timeunits_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
