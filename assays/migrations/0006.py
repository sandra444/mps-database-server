...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AssayTimepoint.timepoint'
        db.alter_column(u'assays_assaytimepoint', 'timepoint', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'AssayTimepoint.timepoint'
        db.alter_column(u'assays_assaytimepoint', 'timepoint', self.gf('django.db.models.fields.IntegerField')())
