...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssayRun.file'
        db.add_column(u'assays_assayrun', 'file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'AssayRun.start_date'
        db.alter_column(u'assays_assayrun', 'start_date', self.gf('django.db.models.fields.DateTimeField')(default='2014-10-03'))

        # Changing field 'AssayChipReadout.device'
        db.alter_column(u'assays_assaychipreadout', 'device_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['microdevices.OrganModel']))

        # Changing field 'AssayChipRawData.value'
        db.alter_column(u'assays_assaychiprawdata', 'value', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):
        # Deleting field 'AssayRun.file'
        db.delete_column(u'assays_assayrun', 'file')


        # Changing field 'AssayRun.start_date'
        db.alter_column(u'assays_assayrun', 'start_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'AssayChipReadout.device'
        db.alter_column(u'assays_assaychipreadout', 'device_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['microdevices.Microdevice']))

        # Changing field 'AssayChipRawData.value'
        db.alter_column(u'assays_assaychiprawdata', 'value', self.gf('django.db.models.fields.FloatField')(default=1))
