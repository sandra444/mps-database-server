...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssayTestResult.group'
        db.add_column(u'assays_assaytestresult', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.Group']),
                      keep_default=False)

        # Adding field 'AssayTestResult.restricted'
        db.add_column(u'assays_assaytestresult', 'restricted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AssayChipSetup.group'
        db.add_column(u'assays_assaychipsetup', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.Group']),
                      keep_default=False)

        # Adding field 'AssayChipSetup.restricted'
        db.add_column(u'assays_assaychipsetup', 'restricted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AssayRun.group'
        db.add_column(u'assays_assayrun', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.Group']),
                      keep_default=False)

        # Adding field 'AssayRun.restricted'
        db.add_column(u'assays_assayrun', 'restricted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AssayChipReadout.group'
        db.add_column(u'assays_assaychipreadout', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.Group']),
                      keep_default=False)

        # Adding field 'AssayChipReadout.restricted'
        db.add_column(u'assays_assaychipreadout', 'restricted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssayTestResult.group'
        db.delete_column(u'assays_assaytestresult', 'group_id')

        # Deleting field 'AssayTestResult.restricted'
        db.delete_column(u'assays_assaytestresult', 'restricted')

        # Deleting field 'AssayChipSetup.group'
        db.delete_column(u'assays_assaychipsetup', 'group_id')

        # Deleting field 'AssayChipSetup.restricted'
        db.delete_column(u'assays_assaychipsetup', 'restricted')

        # Deleting field 'AssayRun.group'
        db.delete_column(u'assays_assayrun', 'group_id')

        # Deleting field 'AssayRun.restricted'
        db.delete_column(u'assays_assayrun', 'restricted')

        # Deleting field 'AssayChipReadout.group'
        db.delete_column(u'assays_assaychipreadout', 'group_id')

        # Deleting field 'AssayChipReadout.restricted'
        db.delete_column(u'assays_assaychipreadout', 'restricted')
    ...
    models = {
        ...
        u'assays.assaychipsetup': {
            ...
            'restricted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'scientist': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'setup_date': ('django.db.models.fields.DateField', [], {}),
        ...
        u'assays.assayresult': {
            ...
            'assay_name': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assays.AssayChipReadoutAssay']"}),
        ...
        u'assays.assaytestresult': {
            ...
            'chip_setup': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assays.AssayChipSetup']"}),
