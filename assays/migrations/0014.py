...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AssayDeviceReadout.readout_unit'
        db.alter_column(u'assays_assaydevicereadout', 'readout_unit_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['assays.ReadoutUnit']))

    def backwards(self, orm):

        # Changing field 'AssayDeviceReadout.readout_unit'
        db.alter_column(u'assays_assaydevicereadout', 'readout_unit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.ReadoutUnit'], null=True))
