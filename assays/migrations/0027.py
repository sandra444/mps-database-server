...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assaydatafileupload_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='assaydatafileupload_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assayfailurereason_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='assayfailurereason_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
                'abstract': False,
            },
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assaymatrix_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='assaymatrix_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
...
, on_delete=models.CASCADE                ('device', models.ForeignKey(verbose_name=b'Device', to='microdevices.Microdevice')),
, on_delete=models.CASCADE                ('failure_reason', models.ForeignKey(blank=True, to='assays.AssayFailureReason', null=True)),
, on_delete=models.CASCADE                ('matrix', models.ForeignKey(blank=True, to='assays.AssayMatrix', null=True)),
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assaymatrixitem_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('organ_model', models.ForeignKey(verbose_name=b'Model', blank=True, to='microdevices.OrganModel', null=True)),
, on_delete=models.CASCADE                ('organ_model_protocol', models.ForeignKey(verbose_name=b'Model Protocol', blank=True, to='microdevices.OrganModelProtocol', null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='assaymatrixitem_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assaysetting_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='assaysetting_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
                'abstract': False,
            },
...
, on_delete=models.CASCADE                ('biosensor', models.ForeignKey(to='cellsamples.Biosensor')),
, on_delete=models.CASCADE                ('cell_sample', models.ForeignKey(to='cellsamples.CellSample')),
, on_delete=models.CASCADE            ],
            options={
...
, on_delete=models.CASCADE            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.FloatField(blank=True)),
                ('addition_location', models.ForeignKey(blank=True, to='assays.AssaySampleLocation', null=True)),
, on_delete=models.CASCADE                ('matrix_item', models.ForeignKey(to='assays.AssayMatrixItem')),
, on_delete=models.CASCADE                ('setting', models.ForeignKey(to='assays.AssaySetting')),
, on_delete=models.CASCADE            ],
        ),
        migrations.CreateModel(
            name='AssayStudy',
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assaystudy_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='assaystudy_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
                'verbose_name': 'Study',
...
, on_delete=models.CASCADE                ('study', models.ForeignKey(blank=True, to='assays.AssayStudy', null=True)),
, on_delete=models.CASCADE                ('target', models.ForeignKey(to='assays.AssayTarget')),
, on_delete=models.CASCADE            ],
        ),
        migrations.CreateModel(
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assaystudyconfiguration_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='assaystudyconfiguration_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
...
, on_delete=models.CASCADE                ('study_configuration', models.ForeignKey(to='assays.AssayStudyConfiguration')),
, on_delete=models.CASCADE            ],
        ),
        migrations.CreateModel(
...
, on_delete=models.CASCADE                ('study', models.ForeignKey(to='assays.AssayStudy')),
, on_delete=models.CASCADE            ],
        ),
        migrations.CreateModel(
