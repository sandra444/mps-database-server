...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'AssayTestResult', fields ['chip_setup']
        db.create_unique(u'assays_assaytestresult', ['chip_setup_id'])

        # Adding field 'AssayRun.cell_characterization'
        db.add_column(u'assays_assayrun', 'cell_characterization',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'AssayChipReadout.readout_start_time'
        db.alter_column(u'assays_assaychipreadout', 'readout_start_time', self.gf('django.db.models.fields.DateField')(default='2001-01-01'))
        # Adding unique constraint on 'AssayChipReadout', fields ['chip_setup']
        db.create_unique(u'assays_assaychipreadout', ['chip_setup_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AssayChipReadout', fields ['chip_setup']
        db.delete_unique(u'assays_assaychipreadout', ['chip_setup_id'])

        # Removing unique constraint on 'AssayTestResult', fields ['chip_setup']
        db.delete_unique(u'assays_assaytestresult', ['chip_setup_id'])

        # Deleting field 'AssayRun.cell_characterization'
        db.delete_column(u'assays_assayrun', 'cell_characterization')
    ...
    models = {
        ...
        u'assays.assaychipreadout': {
            ...
            'chip_setup': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assays.AssayChipSetup']", 'unique': 'True', 'null': 'True'}),
            ...
            'readout_start_time': ('django.db.models.fields.DateField', [], {}),
            'restricted': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'signed_off_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'timeunit': ('django.db.models.fields.related.ForeignKey', [], {'default': '3', 'to': u"orm['assays.TimeUnits']"}),
        ...
        u'assays.assayrun': {
            ...
            'cell_characterization': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'assays.assaytestresult': {
            ...
            'chip_setup': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assays.AssayChipSetup']", 'unique': 'True'}),
