...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'AssayRun', fields ['name']
        db.delete_unique(u'assays_assayrun', ['name'])

        # Deleting model 'AssayFindingType'
        db.delete_table(u'assays_assayfindingtype')

        # Deleting model 'AssayTest'
        db.delete_table(u'assays_assaytest')

        # Deleting model 'AssayFinding'
        db.delete_table(u'assays_assayfinding')

        # Adding model 'AssayResultType'
        db.create_table(u'assays_assayresulttype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assayresulttype_created-by', null=True, to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assayresulttype_modified-by', null=True, to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('signed_off_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assayresulttype_signed_off_by', null=True, to=orm['auth.User'])),
            ('signed_off_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('locked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('assay_result_type', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'assays', ['AssayResultType'])

        # Adding model 'AssayPlateTestResult'
        db.create_table(u'assays_assayplatetestresult', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assayplatetestresult_created-by', null=True, to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assayplatetestresult_modified-by', null=True, to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('signed_off_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assayplatetestresult_signed_off_by', null=True, to=orm['auth.User'])),
            ('signed_off_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('locked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('assay_device_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.AssayDeviceReadout'])),
            ('assay_test_time', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('time_units', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.TimeUnits'], null=True, blank=True)),
            ...
            ('value_units', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.PhysicalUnits'], null=True, blank=True)),
        ))
        db.send_create_signal(u'assays', ['AssayPlateTestResult'])

        # Adding model 'AssayResultFunction'
        db.create_table(u'assays_assayresultfunction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assayresultfunction_created-by', null=True, to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assayresultfunction_modified-by', null=True, to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('signed_off_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assayresultfunction_signed_off_by', null=True, to=orm['auth.User'])),
            ('signed_off_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('locked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('function_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('function_results', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'assays', ['AssayResultFunction'])

        # Deleting field 'AssayResult.test_time'
        db.delete_column(u'assays_assayresult', 'test_time')

        # Deleting field 'AssayResult.test_name'
        db.delete_column(u'assays_assayresult', 'test_name_id')

        # Deleting field 'AssayResult.assay_test'
        db.delete_column(u'assays_assayresult', 'assay_test_id')

        # Deleting field 'AssayResult.time_units'
        db.delete_column(u'assays_assayresult', 'time_units_id')

        # Adding field 'AssayResult.assay_result'
        db.add_column(u'assays_assayresult', 'assay_result',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.AssayTestResult'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayResult.result_function'
        db.add_column(u'assays_assayresult', 'result_function',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.AssayResultFunction'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayResult.result'
        db.add_column(u'assays_assayresult', 'result',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=8),
                      keep_default=False)

        # Adding field 'AssayResult.severity'
        db.add_column(u'assays_assayresult', 'severity',
                      self.gf('django.db.models.fields.CharField')(default='-1', max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayResult.result_type'
        db.add_column(u'assays_assayresult', 'result_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.AssayResultType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayRun.center_id'
        db.add_column(u'assays_assayrun', 'center_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['microdevices.MicrophysiologyCenter']),
                      keep_default=False)

        # Deleting field 'AssayTestResult.severity'
        db.delete_column(u'assays_assaytestresult', 'severity')

        # Deleting field 'AssayTestResult.value'
        db.delete_column(u'assays_assaytestresult', 'value')

        # Deleting field 'AssayTestResult.assay_finding_name'
        db.delete_column(u'assays_assaytestresult', 'assay_finding_name_id')

        # Deleting field 'AssayTestResult.compound'
        db.delete_column(u'assays_assaytestresult', 'compound_id')

        # Deleting field 'AssayTestResult.time_units'
        db.delete_column(u'assays_assaytestresult', 'time_units_id')

        # Deleting field 'AssayTestResult.value_units'
        db.delete_column(u'assays_assaytestresult', 'value_units_id')

        # Deleting field 'AssayTestResult.result'
        db.delete_column(u'assays_assaytestresult', 'result')

        # Deleting field 'AssayTestResult.assay_test_time'
        db.delete_column(u'assays_assaytestresult', 'assay_test_time')


        # Changing field 'AssayTestResult.assay_device_readout'
        db.alter_column(u'assays_assaytestresult', 'assay_device_readout_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.AssayChipReadout']))
        # Adding field 'AssayChipReadout.chip_test_type'
        db.add_column(u'assays_assaychipreadout', 'chip_test_type',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'AssayFindingType'
        db.create_table(u'assays_assayfindingtype', (
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('signed_off_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assayfindingtype_modified-by', null=True, to=orm['auth.User'], blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('locked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assayfindingtype_created-by', null=True, to=orm['auth.User'], blank=True)),
            ('signed_off_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assayfindingtype_signed_off_by', null=True, to=orm['auth.User'], blank=True)),
            ('assay_finding_type', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True)),
        ))
        db.send_create_signal(u'assays', ['AssayFindingType'])

        # Adding model 'AssayTest'
        db.create_table(u'assays_assaytest', (
            ('signed_off_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assaytest_signed_off_by', null=True, to=orm['auth.User'], blank=True)),
            ('locked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assaytest_created-by', null=True, to=orm['auth.User'], blank=True)),
            ...
            ('signed_off_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('compound', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['compounds.Compound'], null=True, blank=True)),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assaytest_modified-by', null=True, to=orm['auth.User'], blank=True)),
        ...
        db.send_create_signal(u'assays', ['AssayTest'])

        # Adding model 'AssayFinding'
        db.create_table(u'assays_assayfinding', (
            ('description', self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True)),
            ('assay_finding_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('signed_off_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assayfinding_modified-by', null=True, to=orm['auth.User'], blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('locked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assayfinding_created-by', null=True, to=orm['auth.User'], blank=True)),
            ('signed_off_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assayfinding_signed_off_by', null=True, to=orm['auth.User'], blank=True)),
            ('assay_finding_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.AssayFindingType'], null=True, blank=True)),
        ))
        db.send_create_signal(u'assays', ['AssayFinding'])

        # Deleting model 'AssayResultType'
        db.delete_table(u'assays_assayresulttype')

        # Deleting model 'AssayPlateTestResult'
        db.delete_table(u'assays_assayplatetestresult')

        # Deleting model 'AssayResultFunction'
        db.delete_table(u'assays_assayresultfunction')

        # Adding field 'AssayResult.test_time'
        db.add_column(u'assays_assayresult', 'test_time',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayResult.test_name'
        db.add_column(u'assays_assayresult', 'test_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drugtrials.Test'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayResult.assay_test'
        db.add_column(u'assays_assayresult', 'assay_test',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['assays.AssayTest']),
                      keep_default=False)

        # Adding field 'AssayResult.time_units'
        db.add_column(u'assays_assayresult', 'time_units',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.TimeUnits'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'AssayResult.assay_result'
        db.delete_column(u'assays_assayresult', 'assay_result_id')

        # Deleting field 'AssayResult.result_function'
        db.delete_column(u'assays_assayresult', 'result_function_id')

        # Deleting field 'AssayResult.result'
        db.delete_column(u'assays_assayresult', 'result')

        # Deleting field 'AssayResult.severity'
        db.delete_column(u'assays_assayresult', 'severity')

        # Deleting field 'AssayResult.result_type'
        db.delete_column(u'assays_assayresult', 'result_type_id')

        # Deleting field 'AssayRun.center_id'
        db.delete_column(u'assays_assayrun', 'center_id_id')

        # Adding unique constraint on 'AssayRun', fields ['name']
        db.create_unique(u'assays_assayrun', ['name'])

        # Adding field 'AssayTestResult.severity'
        db.add_column(u'assays_assaytestresult', 'severity',
                      self.gf('django.db.models.fields.CharField')(default='-1', max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayTestResult.value'
        db.add_column(u'assays_assaytestresult', 'value',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayTestResult.assay_finding_name'
        db.add_column(u'assays_assaytestresult', 'assay_finding_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['assays.AssayFinding']),
                      keep_default=False)

        # Adding field 'AssayTestResult.compound'
        db.add_column(u'assays_assaytestresult', 'compound',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['compounds.Compound']),
                      keep_default=False)

        # Adding field 'AssayTestResult.time_units'
        db.add_column(u'assays_assaytestresult', 'time_units',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.TimeUnits'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayTestResult.value_units'
        db.add_column(u'assays_assaytestresult', 'value_units',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.PhysicalUnits'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayTestResult.result'
        db.add_column(u'assays_assaytestresult', 'result',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=8),
                      keep_default=False)

        # Adding field 'AssayTestResult.assay_test_time'
        db.add_column(u'assays_assaytestresult', 'assay_test_time',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'AssayTestResult.assay_device_readout'
        db.alter_column(u'assays_assaytestresult', 'assay_device_readout_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.AssayDeviceReadout']))
        # Deleting field 'AssayChipReadout.chip_test_type'
        db.delete_column(u'assays_assaychipreadout', 'chip_test_type')
    ...
    models = {
        ...
        u'assays.assaychiprawdata': {
            'Meta': {'object_name': 'AssayChipRawData'},
        ...
        u'assays.assaychipreadout': {
            'Meta': {'ordering': "('assay_chip_id', 'assay_name')", 'object_name': 'AssayChipReadout'},
            ...
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assays.PhysicalUnits']"})
        },
        ...
        u'assays.assayrun': {
            ...
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {'default': "'Run001'"}),
        ...
        u'assays.assaytestresult': {
            ...
            'assay_device_readout': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assays.AssayChipReadout']"}),
