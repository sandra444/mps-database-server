...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AssayRun.toxicity'
        db.add_column(u'assays_assayrun', 'toxicity',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AssayRun.efficacy'
        db.add_column(u'assays_assayrun', 'efficacy',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AssayRun.disease'
        db.add_column(u'assays_assayrun', 'disease',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AssayRun.toxicity'
        db.delete_column(u'assays_assayrun', 'toxicity')

        # Deleting field 'AssayRun.efficacy'
        db.delete_column(u'assays_assayrun', 'efficacy')

        # Deleting field 'AssayRun.disease'
        db.delete_column(u'assays_assayrun', 'disease')
