...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assaymeasurementtype_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='assaymeasurementtype_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
...
, on_delete=models.CASCADE                ('measurement_type', models.ForeignKey(to='assays.AssayMeasurementType')),
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assaymethod_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='assaymethod_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
                'abstract': False,
            },
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assaysamplelocation_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='assaysamplelocation_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
                'abstract': False,
            },
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assaysupplier_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='assaysupplier_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
                'abstract': False,
            },
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assaytarget_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='assaytarget_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
                'abstract': False,
            },
