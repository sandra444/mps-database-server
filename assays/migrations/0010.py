...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AssayResult.created_on'
        db.delete_column(u'assays_assayresult', 'created_on')

        # Deleting field 'AssayResult.signed_off_date'
        db.delete_column(u'assays_assayresult', 'signed_off_date')

        # Deleting field 'AssayResult.modified_on'
        db.delete_column(u'assays_assayresult', 'modified_on')

        # Deleting field 'AssayResult.modified_by'
        db.delete_column(u'assays_assayresult', 'modified_by_id')

        # Deleting field 'AssayResult.locked'
        db.delete_column(u'assays_assayresult', 'locked')

        # Deleting field 'AssayResult.created_by'
        db.delete_column(u'assays_assayresult', 'created_by_id')

        # Deleting field 'AssayResult.signed_off_by'
        db.delete_column(u'assays_assayresult', 'signed_off_by_id')

        # Adding field 'PhysicalUnits.created_by'
        db.add_column(u'assays_physicalunits', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='physicalunits_created-by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'PhysicalUnits.created_on'
        db.add_column(u'assays_physicalunits', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PhysicalUnits.modified_by'
        db.add_column(u'assays_physicalunits', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='physicalunits_modified-by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'PhysicalUnits.modified_on'
        db.add_column(u'assays_physicalunits', 'modified_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PhysicalUnits.signed_off_by'
        db.add_column(u'assays_physicalunits', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='physicalunits_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'PhysicalUnits.signed_off_date'
        db.add_column(u'assays_physicalunits', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PhysicalUnits.locked'
        db.add_column(u'assays_physicalunits', 'locked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TimeUnits.created_by'
        db.add_column(u'assays_timeunits', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='timeunits_created-by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'TimeUnits.created_on'
        db.add_column(u'assays_timeunits', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TimeUnits.modified_by'
        db.add_column(u'assays_timeunits', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='timeunits_modified-by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'TimeUnits.modified_on'
        db.add_column(u'assays_timeunits', 'modified_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TimeUnits.signed_off_by'
        db.add_column(u'assays_timeunits', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='timeunits_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'TimeUnits.signed_off_date'
        db.add_column(u'assays_timeunits', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TimeUnits.locked'
        db.add_column(u'assays_timeunits', 'locked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AssayResult.created_on'
        db.add_column(u'assays_assayresult', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'AssayResult.modified_on'
        db.add_column(u'assays_assayresult', 'modified_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayResult.modified_by'
        db.add_column(u'assays_assayresult', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='assayresult_modified-by', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Adding field 'AssayResult.locked'
        db.add_column(u'assays_assayresult', 'locked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AssayResult.created_by'
        db.add_column(u'assays_assayresult', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='assayresult_created-by', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Adding field 'AssayResult.signed_off_by'
        db.add_column(u'assays_assayresult', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='assayresult_signed_off_by', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Deleting field 'PhysicalUnits.created_by'
        db.delete_column(u'assays_physicalunits', 'created_by_id')

        # Deleting field 'PhysicalUnits.created_on'
        db.delete_column(u'assays_physicalunits', 'created_on')

        # Deleting field 'PhysicalUnits.modified_by'
        db.delete_column(u'assays_physicalunits', 'modified_by_id')

        # Deleting field 'PhysicalUnits.modified_on'
        db.delete_column(u'assays_physicalunits', 'modified_on')

        # Deleting field 'PhysicalUnits.signed_off_by'
        db.delete_column(u'assays_physicalunits', 'signed_off_by_id')

        # Deleting field 'PhysicalUnits.signed_off_date'
        db.delete_column(u'assays_physicalunits', 'signed_off_date')

        # Deleting field 'PhysicalUnits.locked'
        db.delete_column(u'assays_physicalunits', 'locked')

        # Deleting field 'TimeUnits.created_by'
        db.delete_column(u'assays_timeunits', 'created_by_id')

        # Deleting field 'TimeUnits.created_on'
        db.delete_column(u'assays_timeunits', 'created_on')

        # Deleting field 'TimeUnits.modified_by'
        db.delete_column(u'assays_timeunits', 'modified_by_id')

        # Deleting field 'TimeUnits.modified_on'
        db.delete_column(u'assays_timeunits', 'modified_on')

        # Deleting field 'TimeUnits.signed_off_by'
        db.delete_column(u'assays_timeunits', 'signed_off_by_id')

        # Deleting field 'TimeUnits.signed_off_date'
        db.delete_column(u'assays_timeunits', 'signed_off_date')

        # Deleting field 'TimeUnits.locked'
        db.delete_column(u'assays_timeunits', 'locked')
    ...
    models = {
        ...
        u'assays.assaydevicereadout': {
            'Meta': {'ordering': "('assay_device_id', 'organ_name', 'assay_name')", 'object_name': 'AssayDeviceReadout'},
        ...
        u'assays.assaytest': {
            'Meta': {'ordering': "('test_date', 'microdevice', 'compound')", 'object_name': 'AssayTest'},
            'assay_device_id': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            'assay_layout': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assays.AssayLayout']"}),
            'cell_sample': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cellsamples.CellSample']"}),
