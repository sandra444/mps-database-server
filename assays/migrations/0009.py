...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssayLayout.signed_off_by'
        db.add_column(u'assays_assaylayout', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaylayout_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AssayLayout.signed_off_date'
        db.add_column(u'assays_assaylayout', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayDeviceReadout.signed_off_by'
        db.add_column(u'assays_assaydevicereadout', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaydevicereadout_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AssayDeviceReadout.signed_off_date'
        db.add_column(u'assays_assaydevicereadout', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayBaseLayout.signed_off_by'
        db.add_column(u'assays_assaybaselayout', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaybaselayout_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AssayBaseLayout.signed_off_date'
        db.add_column(u'assays_assaybaselayout', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayResult.signed_off_by'
        db.add_column(u'assays_assayresult', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assayresult_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AssayResult.signed_off_date'
        db.add_column(u'assays_assayresult', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayTest.signed_off_by'
        db.add_column(u'assays_assaytest', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaytest_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AssayTest.signed_off_date'
        db.add_column(u'assays_assaytest', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayLayoutFormat.signed_off_by'
        db.add_column(u'assays_assaylayoutformat', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaylayoutformat_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AssayLayoutFormat.signed_off_date'
        db.add_column(u'assays_assaylayoutformat', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayWell.signed_off_by'
        db.add_column(u'assays_assaywell', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaywell_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AssayWell.signed_off_date'
        db.add_column(u'assays_assaywell', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayWellType.signed_off_by'
        db.add_column(u'assays_assaywelltype', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaywelltype_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AssayWellType.signed_off_date'
        db.add_column(u'assays_assaywelltype', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayReader.signed_off_by'
        db.add_column(u'assays_assayreader', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assayreader_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AssayReader.signed_off_date'
        db.add_column(u'assays_assayreader', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayModel.signed_off_by'
        db.add_column(u'assays_assaymodel', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaymodel_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AssayModel.signed_off_date'
        db.add_column(u'assays_assaymodel', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayModelType.signed_off_by'
        db.add_column(u'assays_assaymodeltype', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaymodeltype_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AssayModelType.signed_off_date'
        db.add_column(u'assays_assaymodeltype', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssayLayout.signed_off_by'
        db.delete_column(u'assays_assaylayout', 'signed_off_by_id')

        # Deleting field 'AssayLayout.signed_off_date'
        db.delete_column(u'assays_assaylayout', 'signed_off_date')

        # Deleting field 'AssayDeviceReadout.signed_off_by'
        db.delete_column(u'assays_assaydevicereadout', 'signed_off_by_id')

        # Deleting field 'AssayDeviceReadout.signed_off_date'
        db.delete_column(u'assays_assaydevicereadout', 'signed_off_date')

        # Deleting field 'AssayBaseLayout.signed_off_by'
        db.delete_column(u'assays_assaybaselayout', 'signed_off_by_id')

        # Deleting field 'AssayBaseLayout.signed_off_date'
        db.delete_column(u'assays_assaybaselayout', 'signed_off_date')

        # Deleting field 'AssayResult.signed_off_by'
        db.delete_column(u'assays_assayresult', 'signed_off_by_id')

        # Deleting field 'AssayResult.signed_off_date'
        db.delete_column(u'assays_assayresult', 'signed_off_date')

        # Deleting field 'AssayTest.signed_off_by'
        db.delete_column(u'assays_assaytest', 'signed_off_by_id')

        # Deleting field 'AssayTest.signed_off_date'
        db.delete_column(u'assays_assaytest', 'signed_off_date')

        # Deleting field 'AssayLayoutFormat.signed_off_by'
        db.delete_column(u'assays_assaylayoutformat', 'signed_off_by_id')

        # Deleting field 'AssayLayoutFormat.signed_off_date'
        db.delete_column(u'assays_assaylayoutformat', 'signed_off_date')

        # Deleting field 'AssayWell.signed_off_by'
        db.delete_column(u'assays_assaywell', 'signed_off_by_id')

        # Deleting field 'AssayWell.signed_off_date'
        db.delete_column(u'assays_assaywell', 'signed_off_date')

        # Deleting field 'AssayWellType.signed_off_by'
        db.delete_column(u'assays_assaywelltype', 'signed_off_by_id')

        # Deleting field 'AssayWellType.signed_off_date'
        db.delete_column(u'assays_assaywelltype', 'signed_off_date')

        # Deleting field 'AssayReader.signed_off_by'
        db.delete_column(u'assays_assayreader', 'signed_off_by_id')

        # Deleting field 'AssayReader.signed_off_date'
        db.delete_column(u'assays_assayreader', 'signed_off_date')

        # Deleting field 'AssayModel.signed_off_by'
        db.delete_column(u'assays_assaymodel', 'signed_off_by_id')

        # Deleting field 'AssayModel.signed_off_date'
        db.delete_column(u'assays_assaymodel', 'signed_off_date')

        # Deleting field 'AssayModelType.signed_off_by'
        db.delete_column(u'assays_assaymodeltype', 'signed_off_by_id')

        # Deleting field 'AssayModelType.signed_off_date'
        db.delete_column(u'assays_assaymodeltype', 'signed_off_date')
    ...
    models = {
        ...
        u'assays.assayresult': {
            ...
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'signed_off_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assayresult_signed_off_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'signed_off_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'assays.assaytest': {
            ...
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'reader_name': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assays.AssayReader']"}),
            'signed_off_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assaytest_signed_off_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'signed_off_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
