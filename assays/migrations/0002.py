...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AssayResult'
        db.create_table(u'assays_assayresult', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assayresult_created-by', null=True, to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assayresult_modified-by', null=True, to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('locked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('assay_test', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.AssayTest'])),
            ...
            ('test_unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.PhysicalUnits'], null=True, blank=True)),
        ))
        db.send_create_signal(u'assays', ['AssayResult'])

        # Adding model 'AssayTest'
        db.create_table(u'assays_assaytest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaytest_created-by', null=True, to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaytest_modified-by', null=True, to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('locked', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        # Adding model 'PhysicalUnits'
        db.create_table(u'assays_physicalunits', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'assays', ['PhysicalUnits'])

        # Adding model 'TimeUnits'
        db.create_table(u'assays_timeunits', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('unit', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
        ))
        db.send_create_signal(u'assays', ['TimeUnits'])


    def backwards(self, orm):
        # Deleting model 'AssayResult'
        db.delete_table(u'assays_assayresult')

        # Deleting model 'AssayTest'
        db.delete_table(u'assays_assaytest')

        # Deleting model 'PhysicalUnits'
        db.delete_table(u'assays_physicalunits')

        # Deleting model 'TimeUnits'
        db.delete_table(u'assays_timeunits')
