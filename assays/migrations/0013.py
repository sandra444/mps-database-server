...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AssayDeviceReadout.assay_timestamp'
        db.delete_column(u'assays_assaydevicereadout', 'assay_timestamp')

        # Deleting field 'AssayDeviceReadout.readout_timestamp'
        db.delete_column(u'assays_assaydevicereadout', 'readout_timestamp')

        # Adding field 'AssayDeviceReadout.readout_unit'
        db.add_column(u'assays_assaydevicereadout', 'readout_unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.ReadoutUnit'], null=True),
                      keep_default=False)

        # Adding field 'AssayDeviceReadout.assay_start_time'
        db.add_column(u'assays_assaydevicereadout', 'assay_start_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayDeviceReadout.readout_start_time'
        db.add_column(u'assays_assaydevicereadout', 'readout_start_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AssayDeviceReadout.assay_timestamp'
        db.add_column(u'assays_assaydevicereadout', 'assay_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayDeviceReadout.readout_timestamp'
        db.add_column(u'assays_assaydevicereadout', 'readout_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'AssayDeviceReadout.readout_unit'
        db.delete_column(u'assays_assaydevicereadout', 'readout_unit_id')

        # Deleting field 'AssayDeviceReadout.assay_start_time'
        db.delete_column(u'assays_assaydevicereadout', 'assay_start_time')

        # Deleting field 'AssayDeviceReadout.readout_start_time'
        db.delete_column(u'assays_assaydevicereadout', 'readout_start_time')
    ...
    models = {
        ...
        u'assays.assaydevicereadout': {
            ...
            'readout_unit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assays.ReadoutUnit']", 'null': 'True'}),
