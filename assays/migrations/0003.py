...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhysicalUnits.unit_type'
        db.add_column(u'assays_physicalunits', 'unit_type',
                      self.gf('django.db.models.fields.CharField')(default='C', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PhysicalUnits.unit_type'
        db.delete_column(u'assays_physicalunits', 'unit_type')
