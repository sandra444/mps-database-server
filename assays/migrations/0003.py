    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='assaychiptestresult_created-by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('group', models.ForeignKey(help_text=b'Bind to a group', to='auth.Group')),
                ('modified_by', models.ForeignKey(related_name='assaychiptestresult_modified-by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='assayplatereadout_created-by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('group', models.ForeignKey(help_text=b'Bind to a group', to='auth.Group')),
                ('modified_by', models.ForeignKey(related_name='assayplatereadout_modified-by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='assayplatesetup_created-by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('group', models.ForeignKey(help_text=b'Bind to a group', to='auth.Group')),
                ('modified_by', models.ForeignKey(related_name='assayplatesetup_modified-by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
