...
, on_delete=models.CASCADE                ('created_by', models.ForeignKey(related_name='assaychiptestresult_created_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('group', models.ForeignKey(help_text=b'Bind to a group', to='auth.Group')),
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assaychiptestresult_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='assaychiptestresult_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
...
, on_delete=models.CASCADE                ('group', models.ForeignKey(help_text=b'Bind to a group', to='auth.Group')),
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assayplatereadout_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
...
, on_delete=models.CASCADE                ('reader_id', models.ForeignKey(verbose_name=b'Reader', to='assays.AssayReader')),
, on_delete=models.CASCADE                ('readout_id', models.ForeignKey(verbose_name=b'Readout', to='assays.AssayPlateReadout')),
, on_delete=models.CASCADE                ('readout_unit', models.ForeignKey(to='assays.ReadoutUnit')),
, on_delete=models.CASCADE            ],
            options={
            },
            bases=(models.Model,),
...
, on_delete=models.CASCADE                ('assay_result', models.ForeignKey(to='assays.AssayPlateTestResult')),
, on_delete=models.CASCADE                ('result_function', models.ForeignKey(verbose_name=b'Function', blank=True, to='assays.AssayResultFunction', null=True)),
, on_delete=models.CASCADE                ('result_type', models.ForeignKey(verbose_name=b'Measure', blank=True, to='assays.AssayResultType', null=True)),
, on_delete=models.CASCADE                ('test_unit', models.ForeignKey(blank=True, to='assays.PhysicalUnits', null=True)),
, on_delete=models.CASCADE            ],
            options={
            },
            bases=(models.Model,),
...
, on_delete=models.CASCADE                ('assay_run_id', models.ForeignKey(verbose_name=b'Study', to='assays.AssayRun')),
, on_delete=models.CASCADE                ('created_by', models.ForeignKey(related_name='assayplatesetup_created_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('group', models.ForeignKey(help_text=b'Bind to a group', to='auth.Group')),
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assayplatesetup_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='assayplatesetup_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
...
, on_delete=models.CASCADE                ('compound', models.ForeignKey(to='compounds.Compound')),
, on_delete=models.CASCADE                ('concentration_unit', models.ForeignKey(to='assays.PhysicalUnits')),
, on_delete=models.CASCADE            ],
            options={
            },
            bases=(models.Model,),
