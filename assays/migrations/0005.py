...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssayLayoutFormat.device'
        db.add_column(u'assays_assaylayoutformat', 'device',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['microdevices.Microdevice']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssayLayoutFormat.device'
        db.delete_column(u'assays_assaylayoutformat', 'device_id')
