...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PhysicalUnits.unit'
        db.alter_column(u'assays_physicalunits', 'unit', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'PhysicalUnits.unit'
        db.alter_column(u'assays_physicalunits', 'unit', self.gf('django.db.models.fields.CharField')(max_length=16))
