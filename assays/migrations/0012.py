...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReadoutUnit'
        db.create_table(u'assays_readoutunit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='readoutunit_created-by', null=True, to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='readoutunit_modified-by', null=True, to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('signed_off_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='readoutunit_signed_off_by', null=True, to=orm['auth.User'])),
            ('signed_off_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('locked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('readout_unit', self.gf('django.db.models.fields.CharField')(unique=True, max_length=512)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
        ))
        db.send_create_signal(u'assays', ['ReadoutUnit'])

        # Adding field 'AssayReadout.elapsed_time'
        db.add_column(u'assays_assayreadout', 'elapsed_time',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Deleting field 'AssayDeviceReadout.organ_name'
        db.delete_column(u'assays_assaydevicereadout', 'organ_name_id')

        # Deleting field 'AssayDeviceReadout.readout_type'
        db.delete_column(u'assays_assaydevicereadout', 'readout_type')

        # Deleting field 'AssayDeviceReadout.time_interval'
        db.delete_column(u'assays_assaydevicereadout', 'time_interval')

        # Deleting field 'AssayDeviceReadout.timepoint'
        db.delete_column(u'assays_assaydevicereadout', 'timepoint')

        # Deleting field 'AssayDeviceReadout.microdevice'
        db.delete_column(u'assays_assaydevicereadout', 'microdevice_id')

        # Deleting field 'AssayDeviceReadout.readout_unit'
        db.delete_column(u'assays_assaydevicereadout', 'readout_unit')


    def backwards(self, orm):
        # Deleting model 'ReadoutUnit'
        db.delete_table(u'assays_readoutunit')

        # Deleting field 'AssayReadout.elapsed_time'
        db.delete_column(u'assays_assayreadout', 'elapsed_time')

        # Adding field 'AssayDeviceReadout.organ_name'
        db.add_column(u'assays_assaydevicereadout', 'organ_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cellsamples.Organ'], null=True),
                      keep_default=False)

        # Adding field 'AssayDeviceReadout.readout_type'
        db.add_column(u'assays_assaydevicereadout', 'readout_type',
                      self.gf('django.db.models.fields.CharField')(default='E', max_length=2),
                      keep_default=False)

        # Adding field 'AssayDeviceReadout.time_interval'
        db.add_column(u'assays_assaydevicereadout', 'time_interval',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayDeviceReadout.timepoint'
        db.add_column(u'assays_assaydevicereadout', 'timepoint',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'AssayDeviceReadout.microdevice'
        raise RuntimeError("Cannot reverse this migration. 'AssayDeviceReadout.microdevice' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'AssayDeviceReadout.microdevice'
        db.add_column(u'assays_assaydevicereadout', 'microdevice',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['microdevices.Microdevice']),
                      keep_default=False)

        # Adding field 'AssayDeviceReadout.readout_unit'
        db.add_column(u'assays_assaydevicereadout', 'readout_unit',
                      self.gf('django.db.models.fields.CharField')(default='RFU', max_length=16),
                      keep_default=False)
    ...
    models = {
        ...
        u'assays.assayfinding': {
            'Meta': {'ordering': "('assay_finding_type', 'assay_finding_name')", 'object_name': 'AssayFinding'},
            'assay_finding_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'assay_finding_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assays.AssayFindingType']", 'null': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assayfinding_created-by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '400', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locked': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assayfinding_modified-by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'signed_off_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assayfinding_signed_off_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'signed_off_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
        u'assays.assayfindingtype': {
            'Meta': {'ordering': "('assay_finding_type',)", 'object_name': 'AssayFindingType'},
            'assay_finding_type': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assayfindingtype_created-by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locked': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assayfindingtype_modified-by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'signed_off_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assayfindingtype_signed_off_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'signed_off_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        u'assays.assaytestresult': {
            ...
            'assay_device_readout': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assays.AssayDeviceReadout']"}),
            'assay_finding_name': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assays.AssayFinding']"}),
