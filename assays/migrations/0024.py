...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssayChipSetup.setup_date'
        db.add_column(u'assays_assaychipsetup', 'setup_date',
                      self.gf('django.db.models.fields.DateField')(default='2011-01-01'),
                      keep_default=False)

        # Deleting field 'AssayChipReadout.assay_start_time'
        db.delete_column(u'assays_assaychipreadout', 'assay_start_time')


    def backwards(self, orm):
        # Deleting field 'AssayChipSetup.setup_date'
        db.delete_column(u'assays_assaychipsetup', 'setup_date')

        # Adding field 'AssayChipReadout.assay_start_time'
        db.add_column(u'assays_assaychipreadout', 'assay_start_time',
