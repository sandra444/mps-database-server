...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AssayChipSetup'
        db.create_table(u'assays_assaychipsetup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaychipsetup_created-by', null=True, to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaychipsetup_modified-by', null=True, to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('signed_off_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assaychipsetup_signed_off_by', null=True, to=orm['auth.User'])),
            ('signed_off_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('locked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('assay_run_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.AssayRun'])),
            ('device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['microdevices.OrganModel'])),
            ('assay_chip_id', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('chip_test_type', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('compound', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['compounds.Compound'], null=True, blank=True)),
            ('concentration', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True)),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.PhysicalUnits'], null=True, blank=True)),
        ...
        db.send_create_signal(u'assays', ['AssayChipSetup'])

        # Adding model 'AssayChipCells'
        db.create_table(u'assays_assaychipcells', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('assay_chip', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.AssayChipSetup'], null=True, blank=True)),
            ('cell_sample', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cellsamples.CellSample'])),
            ('cell_biosensor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cellsamples.Biosensor'])),
            ('cellsample_density', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('cellsample_density_unit', self.gf('django.db.models.fields.CharField')(default='CP', max_length=8)),
            ('cell_passage', self.gf('django.db.models.fields.CharField')(default='-', max_length=16)),
        ))
        db.send_create_signal(u'assays', ['AssayChipCells'])


        # Changing field 'AssayTestResult.assay_device_readout'
        db.alter_column(u'assays_assaytestresult', 'assay_device_readout_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.AssayRun']))
        # Adding field 'AssayResult.assay_name'
        db.add_column(u'assays_assayresult', 'assay_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['assays.AssayChipReadout']),
                      keep_default=False)

        # Adding field 'AssayRun.type1'
        db.add_column(u'assays_assayrun', 'type1',
                      self.gf('django.db.models.fields.CharField')(default='TOX', max_length=13),
                      keep_default=False)

        # Adding field 'AssayRun.type2'
        db.add_column(u'assays_assayrun', 'type2',
                      self.gf('django.db.models.fields.CharField')(max_length=13, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssayRun.type3'
        db.add_column(u'assays_assayrun', 'type3',
                      self.gf('django.db.models.fields.CharField')(max_length=13, null=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'AssayChipReadout.device'
        db.delete_column(u'assays_assaychipreadout', 'device_id')

        # Deleting field 'AssayChipReadout.concentration'
        db.delete_column(u'assays_assaychipreadout', 'concentration')

        # Deleting field 'AssayChipReadout.unit'
        db.delete_column(u'assays_assaychipreadout', 'unit_id')

        # Deleting field 'AssayChipReadout.cellsample_density'
        db.delete_column(u'assays_assaychipreadout', 'cellsample_density')

        # Deleting field 'AssayChipReadout.assay_chip_id'
        db.delete_column(u'assays_assaychipreadout', 'assay_chip_id')

        # Deleting field 'AssayChipReadout.compound'
        db.delete_column(u'assays_assaychipreadout', 'compound_id')

        # Deleting field 'AssayChipReadout.cell_sample'
        db.delete_column(u'assays_assaychipreadout', 'cell_sample_id')

        # Deleting field 'AssayChipReadout.cellsample_density_unit'
        db.delete_column(u'assays_assaychipreadout', 'cellsample_density_unit')

        # Adding field 'AssayChipReadout.chip_setup'
        db.add_column(u'assays_assaychipreadout', 'chip_setup',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assays.AssayChipSetup'], null=True),
                      keep_default=False)

        # Adding field 'AssayChipReadout.type'
        db.add_column(u'assays_assaychipreadout', 'type',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=13),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AssayChipSetup'
        db.delete_table(u'assays_assaychipsetup')

        # Deleting model 'AssayChipCells'
        db.delete_table(u'assays_assaychipcells')
        ...
        # Deleting field 'AssayResult.assay_name'
        db.delete_column(u'assays_assayresult', 'assay_name_id')

        # Deleting field 'AssayRun.type1'
        db.delete_column(u'assays_assayrun', 'type1')

        # Deleting field 'AssayRun.type2'
        db.delete_column(u'assays_assayrun', 'type2')

        # Deleting field 'AssayRun.type3'
        db.delete_column(u'assays_assayrun', 'type3')
        ...
        # Adding field 'AssayChipReadout.device'
        db.add_column(u'assays_assaychipreadout', 'device',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['microdevices.OrganModel']),
                      keep_default=False)

        # Adding field 'AssayChipReadout.concentration'
        db.add_column(u'assays_assaychipreadout', 'concentration',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'AssayChipReadout.unit'
        db.add_column(u'assays_assaychipreadout', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['assays.PhysicalUnits']),
                      keep_default=False)

        # Adding field 'AssayChipReadout.cellsample_density'
        db.add_column(u'assays_assaychipreadout', 'cellsample_density',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'AssayChipReadout.assay_chip_id'
        db.add_column(u'assays_assaychipreadout', 'assay_chip_id',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=512),
                      keep_default=False)

        # Adding field 'AssayChipReadout.compound'
        db.add_column(u'assays_assaychipreadout', 'compound',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['compounds.Compound']),
                      keep_default=False)

        # Adding field 'AssayChipReadout.cell_sample'
        db.add_column(u'assays_assaychipreadout', 'cell_sample',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['cellsamples.CellSample']),
                      keep_default=False)

        # Adding field 'AssayChipReadout.cellsample_density_unit'
        db.add_column(u'assays_assaychipreadout', 'cellsample_density_unit',
                      self.gf('django.db.models.fields.CharField')(default='ML', max_length=8),
                      keep_default=False)

        # Deleting field 'AssayChipReadout.chip_setup'
        db.delete_column(u'assays_assaychipreadout', 'chip_setup_id')

        # Deleting field 'AssayChipReadout.type'
        db.delete_column(u'assays_assaychipreadout', 'type')
    ...
    models = {
        ...
        u'assays.assaychipcells': {
            ...
            'cell_biosensor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cellsamples.Biosensor']"}),
        ...
        u'assays.assaychipreadout': {
            'Meta': {'ordering': "('assay_name',)", 'object_name': 'AssayChipReadout'},
