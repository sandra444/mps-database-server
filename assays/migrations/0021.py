...
, on_delete=models.CASCADE                ('compound_instance', models.ForeignKey(blank=True, to='compounds.CompoundInstance', null=True)),
, on_delete=models.CASCADE                ('concentration_unit', models.ForeignKey(verbose_name=b'Concentration Unit', to='assays.PhysicalUnits')),
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assaydataupload_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('plate_readout', models.ManyToManyField(to='assays.AssayPlateReadout')),
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='assayqualityindicator_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='assayqualityindicator_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
                'abstract': False,
            },
