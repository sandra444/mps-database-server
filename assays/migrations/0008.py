...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AssayDeviceReadout.timeunit'
        db.delete_column(u'assays_assaydevicereadout', 'timeunit')

        # Adding field 'AssayDeviceReadout.timeunit'
        db.add_column(u'assays_assaydevicereadout', 'timeunit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['assays.TimeUnits']),
                      keep_default=False)


    def backwards(self, orm):
        raise ValueError('Cannot perform the backwords migration')
