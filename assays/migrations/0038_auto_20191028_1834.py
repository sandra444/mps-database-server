# Generated by Django 2.1.9 on 2019-10-28 22:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=255, verbose_name='Assay Plate Map Name')),
                ('description', models.CharField(blank=True, default='', max_length=2000)),
                ('device', models.IntegerField(blank=True, choices=[(24, '24 Well Plate'), (96, '96 Well Plate'), (384, '384 Well Plate')], default=24, verbose_name='Plate Size')),
                ...
                ('plate_reader_unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='assays.PhysicalUnits', verbose_name='Reporting Unit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('processing_set', models.CharField(blank=True, max_length=255, verbose_name='this will be a link to later')),
                ('assayplatereadermap', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='assays.AssayPlateReaderMap')),
