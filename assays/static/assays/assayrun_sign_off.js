    ...
    function set_labels(owner) {
        if (signed_off_selector.prop('checked')) {
            ...
            if (owner) {
                ...
                // mark_reviewed_label.text('Click Here to Revoke your Approval');
                // sign_off_confirm_warning.html(
                //     'Removing the Approval will prevent consortium viewers from viewing this Study\'s data.' +
                //     '<br><br>Are you sure you want to change the Approval status?'
                // );
            }
        }
            ...
            if (owner) {
                ...
                // sign_off_confirm_warning.html(
                //     'Approving will allow consortium viewers to view this Study\'s data (granted all other Stakeholders Approve as well)' +
                //     '<br><br>Are you sure you want to change the Approval status?'
                // );
            }
        }
