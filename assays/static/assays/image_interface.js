    ...
    var dialogOptions = {
        ...
        open: function() {
            ...
            if (popupDialogData["file_name"].match(/.(jpg|jpeg|png|gif|tif|tiff)$/i)){
                ...
                type = "Video";
                detailDisplay = '<div class="thumbnail col-md-12 col-lg-4"><video width="600" height="600" controls><source src="/media/assay_images/'+study_pk+'/'+popupDialogData["file_name"]+'" type="video/mp4"></source></video></div>'
            }
