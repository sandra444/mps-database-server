...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='manufacturer_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='manufacturer_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
...
, on_delete=models.CASCADE                ('groups', models.ManyToManyField(to='auth.Group')),
...
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='microphysiologycenter_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
...
, on_delete=models.CASCADE                ('created_by', models.ForeignKey(related_name='organmodel_created_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('device', models.ForeignKey(blank=True, to='microdevices.Microdevice', null=True)),
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='organmodel_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('organ', models.ForeignKey(to='cellsamples.Organ')),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='organmodel_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
...
, on_delete=models.CASCADE                ('organ_model', models.ForeignKey(verbose_name=b'Organ Model', to='microdevices.OrganModel')),
, on_delete=models.CASCADE            ],
            options={
            },
            bases=(models.Model,),
