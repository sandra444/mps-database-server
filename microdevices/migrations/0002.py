...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MicrophysiologyCenter.signed_off_by'
        db.add_column(u'microdevices_microphysiologycenter', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='microphysiologycenter_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'MicrophysiologyCenter.signed_off_date'
        db.add_column(u'microdevices_microphysiologycenter', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'OrganModel.signed_off_by'
        db.add_column(u'microdevices_organmodel', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='organmodel_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'OrganModel.signed_off_date'
        db.add_column(u'microdevices_organmodel', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Microdevice.signed_off_by'
        db.add_column(u'microdevices_microdevice', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='microdevice_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Microdevice.signed_off_date'
        db.add_column(u'microdevices_microdevice', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Manufacturer.signed_off_by'
        db.add_column(u'microdevices_manufacturer', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='manufacturer_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Manufacturer.signed_off_date'
        db.add_column(u'microdevices_manufacturer', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MicrophysiologyCenter.signed_off_by'
        db.delete_column(u'microdevices_microphysiologycenter', 'signed_off_by_id')

        # Deleting field 'MicrophysiologyCenter.signed_off_date'
        db.delete_column(u'microdevices_microphysiologycenter', 'signed_off_date')

        # Deleting field 'OrganModel.signed_off_by'
        db.delete_column(u'microdevices_organmodel', 'signed_off_by_id')

        # Deleting field 'OrganModel.signed_off_date'
        db.delete_column(u'microdevices_organmodel', 'signed_off_date')

        # Deleting field 'Microdevice.signed_off_by'
        db.delete_column(u'microdevices_microdevice', 'signed_off_by_id')

        # Deleting field 'Microdevice.signed_off_date'
        db.delete_column(u'microdevices_microdevice', 'signed_off_date')

        # Deleting field 'Manufacturer.signed_off_by'
        db.delete_column(u'microdevices_manufacturer', 'signed_off_by_id')

        # Deleting field 'Manufacturer.signed_off_date'
        db.delete_column(u'microdevices_manufacturer', 'signed_off_date')
