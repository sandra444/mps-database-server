...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='biosensor_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='biosensor_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='cellsubtype_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='cellsubtype_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
...
, on_delete=models.CASCADE                ('created_by', models.ForeignKey(related_name='celltype_created_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='celltype_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='organ_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='organ_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
                'ordering': ('organ_name',),
            },
...
, on_delete=models.CASCADE                ('modified_by', models.ForeignKey(related_name='supplier_modified_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE                ('signed_off_by', models.ForeignKey(related_name='supplier_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
, on_delete=models.CASCADE            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.AddField(
            model_name='celltype',
            name='organ',
            field=models.ForeignKey(to='cellsamples.Organ'),
, on_delete=models.CASCADE            preserve_default=True,
        ),
        migrations.AddField(
            model_name='celltype',
            name='signed_off_by',
            field=models.ForeignKey(related_name='celltype_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True),
, on_delete=models.CASCADE            preserve_default=True,
        ),
        ...
        migrations.AddField(
            ...
            name='cell_type',
            field=models.ForeignKey(to='cellsamples.CellType'),
, on_delete=models.CASCADE            preserve_default=True,
        ),
        migrations.AddField(
            model_name='cellsample',
...
, on_delete=models.CASCADE            preserve_default=True,
        ...
        migrations.AddField(
            model_name='cellsample',
            name='signed_off_by',
            field=models.ForeignKey(related_name='cellsample_signed_off_by', blank=True, to=settings.AUTH_USER_MODEL, null=True),
, on_delete=models.CASCADE            preserve_default=True,
        ),
        migrations.AddField(
            model_name='cellsample',
            name='supplier',
            field=models.ForeignKey(to='cellsamples.Supplier'),
, on_delete=models.CASCADE            preserve_default=True,
        ),
        migrations.AddField(
