...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Biosensor'
        db.create_table(u'cellsamples_biosensor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='biosensor_created-by', null=True, to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='biosensor_modified-by', null=True, to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('signed_off_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='biosensor_signed_off_by', null=True, to=orm['auth.User'])),
            ...
            ('lot_number', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True)),
        ))
        db.send_create_signal(u'cellsamples', ['Biosensor'])


        # Changing field 'CellSample.isolation_datetime'
        db.alter_column(u'cellsamples_cellsample', 'isolation_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting model 'Biosensor'
        db.delete_table(u'cellsamples_biosensor')


        # Changing field 'CellSample.isolation_datetime'
        db.alter_column(u'cellsamples_cellsample', 'isolation_datetime', self.gf('django.db.models.fields.DateTimeField')(default=2))
