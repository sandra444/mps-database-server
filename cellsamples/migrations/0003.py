...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CellType', fields ['cell_type']
        db.delete_unique(u'cellsamples_celltype', ['cell_type'])


    def backwards(self, orm):
        # Adding unique constraint on 'CellType', fields ['cell_type']
        db.create_unique(u'cellsamples_celltype', ['cell_type'])
