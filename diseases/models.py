...
class Disease(models.Model):
    ...
    overview_state_blurb = models.TextField(default='', blank=True, help_text="NOTE: Use HTML tags to create lists.")
    ...
    clinicaldata_blurb = models.TextField(default='', blank=True, help_text="NOTE: Use HTML tags to create lists.")
