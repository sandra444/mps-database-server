...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Compound.signed_off_by'
        db.add_column(u'compounds_compound', 'signed_off_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='compound_signed_off_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Compound.signed_off_date'
        db.add_column(u'compounds_compound', 'signed_off_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Compound.signed_off_by'
        db.delete_column(u'compounds_compound', 'signed_off_by_id')

        # Deleting field 'Compound.signed_off_date'
        db.delete_column(u'compounds_compound', 'signed_off_date')
