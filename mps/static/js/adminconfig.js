...
var MODELS = {
    ...
    'Assays': {
        'Studies': [1, 'Studies', 0],
        'Chip Setups': [2, 'Chip Setup', 1, true],
        'Chip Readouts': [3, 'Chip Readouts', 2, true],
        'Chip Results': [4, 'Chip Results', 3, true],
        'Result types': [5, 'Result Types', 2, true],
        'Functions': [6, 'Functions', 3, true],
        'Plate Setups': [12, 'Plate Setups', 1, true],
        'Plate Readouts': [13, 'Plate Readouts', 2, true],
        'Plate Results' : [14, 'Plate Results', 3, true],
        'Assay layouts': [15, 'Assay Layouts', 0, true],
        'Assay models': [28, 'Assay Models', 0, true],
        'Assay model types': [30, 'Assay Types', 1, true],
        'Assay base layouts': [16, 'Base Layouts', 3, true],
        'Assay layout formats': [18, 'Layout Formats', 4, true],
        'Assay well types': [20, 'Virtual Well Types', 4, true],
        'Assay readers': [32, 'Reader Devices', 2, true],
    ...
    'Cellsamples': {
        ...
        'Cell Origins': [8, 'Cell Subtypes', 2],
